...
<div id="carousel-barn" class="carousel slide" data-bs-ride="carousel">
  <div class="carousel-indicators">
    ...
    <!-- <button type="button" data-bs-target="#carousel-barn" data-bs-slide-to="1" aria-label="Slide 2"></button>
    <button type="button" data-bs-target="#carousel-barn" data-bs-slide-to="2" aria-label="Slide 3"></button>
    <button type="button" data-bs-target="#carousel-barn" data-bs-slide-to="3" aria-label="Slide 4"></button>
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/pics/cotton/cotton_front.jpg" class="d-block w-100" alt="...">
    </div>
  ...
  <button class="carousel-control-next" type="button" data-bs-target="#carousel-barn" data-bs-slide="next">
    <span class="carousel-control-next-icon" aria-hidden="true"></span>
    <span class="visually-hidden">Next</span>
  </button>
</div> <!-- End Carousel -->

<strong>Cotton Street</strong>
<br>2 BR, 1 BA, living area, kitchen with eating space, washer/dryer connections in bathroom, stove and refrigerator, window AC units. Off-street parking. 900 sq. ft.
